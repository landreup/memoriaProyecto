...
Basándonos en el diagrama de descomposición del trabajo mostrado XXXXXX
el cuál muestra en jerarquía todas las actividades que se tienen que realizar
durante el desarrollo del proyecto, en esta sección se listan y describen todas
esas tareas.

**Preparación al proyecto**: En este proceso se adquieren los conocimientos
...
del sistema.
* *Requisitos funcionales*: Los requisitos funcionales engloban a todo
...
utilizada para el desarollo del cronograma será el diagrama de Gantt, el cual se
...
paralelismo en las tareas al disponer de un solo desarollador las tareas se
...
puntos y se pueden observar esquematizados en la figura ######:
...
El procedimiento a seguir en la realización de la presentación, se puede ver
esquematizado en la figura ###### y se corresponde con los siguientes puntos:
