...
Los roles del sistema o tipos de usuario del sistema representan a los usuarios que interviernen en el sistema. 
Estos usuarios incluirán a los agentes evaluadores del sistema de evaluación. Como se ha comentado en la 
[descripción del proyecto (Cápitulo 2)](#descripcion) los agentes evaluadores del sistema serán los *Profesores*,
