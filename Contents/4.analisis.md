...
|Autor|Luis Andreu Puchol|
|Fuentes|Ángeles López y María José Aramburu|
|Descripción|El sistema necesita que el cliente disponga de un navegador web con conexión a Internet y posibilidad de ejecutar javascript para acceder a la aplicación|
|Comentarios||
