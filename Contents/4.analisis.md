...
En este capítulo se van a describir los requisitos que el software del sistema debe 
...
|Fuentes|Ángeles López y María José Aramburu|
|Requisitos asociados| |
|Descripción| El sistema debe permitir a un profesor definir la información relativa a un proyecto así como asígnar un alumno al proyecto|
|Comentarios| |
...
|Fuentes|Ángeles López y María José Aramburu|
|Requisitos asociados| |
|Descripción|El sistema debe permitir a los profesores modificar la información relativa al proyecto|
|Comentarios||
...
|Fuentes|Ángeles López y María José Aramburu|
|Requisitos asociados| |
|Descripción|El sistema debe permitir a los profesores gestionar toda la información de un alumno necesaria para la aplicación. Esta acción incluirá la definición y la edición de los alumnos|
|Comentarios||
...
|Fuentes|Ángeles López y María José Aramburu|
|Requisitos asociados| |
|Descripción|El sistema debe mostrar al coordinar una lista de todos los profesores que existan en la aplicación agrupados por el rol que ejerzan en la aplicación|
|Comentarios||
...
|Fuentes|Ángeles López y María José Aramburu|
|Requisitos asociados| |
|Descripción|El sistema debe permitir al coordinar cambiar el rol de los profesores. De esta forma cambiar las acciones que un profesor pueda realizar|
|Comentarios||

### Gestión del sistema de evaluación ###
