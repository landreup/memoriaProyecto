...
de la estructura. Para cada módulo de la [arquitectura software](#arquitecturaSoftware)
...
clase y la herencia del mapeo objeto-relacional (*Object-Relational mapping*,
ORM) que nos proporciona Django hace que no necesitamos definir nada más ya 
...
proporcionará un comando para el envío de los formularios de las etapas
mediante correos electrónicos en las fechas establecidas. Este comado junto 
con la definición de un proceso automático realizará el envío de los 
formularios de las etapas mediante correos electrónicos en las fechas
establecidas.
...
curso en componente de modelos. De igual forma que en el [módulo de gestión de Alumnos](#moduloAlumnos),
...
campo. Todas las acciones referentes a éste formulario se realizarán en el
componente de formularios. Este componente se definirá de igual forma
que para la [gestión de alumnos](#moduloAlumnos), se utilizará la herencia de la clase
...
igual que se describe en los apartados anteriores para este componente.
...
módulos un componente vistas que gestionará el acceso a estas funciones.
...
valoraciones de estos. Para conseguir ésto, se realizará de la misma forma
...
preguntas y cálcular las valoraciones de las evaluaciones. Esta acción se
...
después los más complejos. El primer módulo que se probará será el módulo de gestión
profesores, el segundo módulo que se probará será el módulo de gestión de cursos. A
...
con conocimientos de instalación de servidores web ya que en él se ha
