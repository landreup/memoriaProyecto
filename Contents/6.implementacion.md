...
el desarrollo de la aplicación. Se comentará que plataforma de desarrollo
se ha elegido para el desarrollo de la aplicación y las razones de porqué
se ha elegido. A continuación se detallarán el servidor de base de datos
y los servidores web que se utilizarán.

Para la elección se plantearón dos plataformas de desarrollo Symfony y
Django. Son dos plataformas con una filosofia similar, las dos plataformas proveen
...
plataformas es el lenguaje de programación sobre el cuál están desarroladas.
...
de la aplicación será PostgreSQL 9.1 sobre el pueto 5432. Se ha utilizado este
servidor de base de datos por eleción de las tutoras del proyecto. Respecto a los
...
mediante correos electrónicos. Este comado junto con la definición de la ejecución 
