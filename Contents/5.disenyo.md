...
observar las clases de objetos que habrán en el sistema y sus relaciones.

![Modelo de Datos](images/modeloDatos.png "Modelo de datos")

### Campos de cada clase de objetos ###
...
* **SistemaEvaluación**: ELos objetos de esta clase tendrán definidos los campos `curso` y `estado`. El 
...
será una cadena y el campo `tipoRespuesta` será un caracter que indicará el tipo de respuesta
...
* **EstadoProyectoEnCurso**: Los objetos de esta clase tendrá definidos los campos `proyecto` y `hito`.
...
`proyecto` y `hito` serán relaciones con los objetos de la clase *Proyecto* y *Hito*.

* **ProyectoParaRevisiónEnCurso**: Los objetos de esta clase tendrá definidos los campos `proyecto` y `campos`.
Todos los campos estarán almacenados en la base de datos. El
campo `campos` será un campo de texto y contendrá un listado con los campos que se necesitan completar
del proyecto. Además el campo `proyecto` será una relación con los objetos de la clase *Proyecto*. Esta tabla servirá
...
formulario. Además los campos `proyecto` y `hito` serán relaciones con los objetos de la clase *Proyecto* y *Hito*.

* **EvaluacionesFormulario**: Los objetos de esta clase tendrá definidos los campos `evaluacion`, `formulario` y 
...
`evaluacion` y `formulario` serán relaciones con los objetos de la clase *Evaluacion* y *Formulario*.

* **Valoración**: Los objetos de esta clase tendrá definidos los campos `pregunta`, `respuesta` y `evaluacionFormulario`.
...
`evaluacionFormulario` serán relaciones con los objetos de la clase *Pregunta* y *EvaluacionesFormularios*.

### Relaciones entre las clases de objeto ###

A continuación se definirán los relaciones entre las diferenes clases de objetos.
...
* **Proyecto-Curso**: Esta relación representa el curso al que pertence el proyecto. La cardinalidad de esta relación será que todo proyecto tendrá definido un curso y los cursos podrán tener varios proyectos.
...
* **Formulario-Proyecto**: Esta relación representa el proyecto asociado a un formulario. La cardinalidad de esta relación será que un formulario tendrá definido el proyecto al que esta asociado y que un proyecto podrá tener definidos varios formularios.

* **Formulario-Hito**: Esta relación representa el hito asociado a un formulario. La cardinalidad de esta relación será que un formulario tendrá definido el hito al que esta asociado y que un hito podrá tener definidos varios formularios.

* **Formulario-EvaluacionesFormulario**: Esta relación representa las evaluaciónes que pueden formar un formulario. La cardinalidad de esta relación será que un formulario podrá tener asociadas varias evaluaciones y que una evaluación de un formulario tendrá asociado el formulario al que pertenece.

* **EvaluacionesFormulario-Evaluacion**: Esta relación representa las evaluaciónes que pueden formar un formulario. La cardinalidad de esta relación será que una evaluación de un formulario tendrá asociada la evaluación a la que pertenece y que una evaluación podrá tener asociadas varias evaluaciones de un formulario.
...
formulario de edición también incluirá la definición de las fechas estimas, con estó se implementará
...
* **Estado de valoración**: Esta pantalla se encargará de mostart un listado del sistema de
...
* **Formulario valoración**: Esta pantalla serña un formulario que se generá a partir de la información
