...
del proyecto. Además el campo `proyecto` será una relación al objeto *Proyecto*. Esta tabla servirá
...
`evaluacion` y `formulario` serán relaciones a los objetos *Evaluacion* y *Formulario*.
...
A la aplicación podrán acceder diferentes tipos de usuarios. En las
...
![Características comunes](images/caracteristicasComunes.tiff "Características comunes")
...
de la aplicación. Además estas funciones se relacionarán con los [requisitos funcionales](#funcionales)
que implementan y se han representado de forma gráfica para los diferentes roles en el apartado
de [organización de las pantallas](#organizacion). Además las capturas de las diferentes pantallas
...
se mostrarán los proyectos que esten asociados al profesor. Las funciones que realizará este módulo 
...
que apartir del correo de asignación de las prácticas se rellene el formulario, esté botón realizará
...
se añadira o se modificará el profesor. En el caso de editar al cambiar de rol un profesor se 
...
eliminar y eliminar sobre pregunta completarán los requisitos funcionares FRQ-18, FRQ-19 y FRQ-20.
...
requisito funcional FRQ-31. Además al mostrar este listado si la evaluacion tiene un formulario
